...
const entrySeed: JournalEntry[] = [
  {
    ...
    type: "story",
    date: "2026-04-24",
    headline: "Mastering AES-256",
    content: "Finally got the PBKDF2 key derivation working smoothly with AES-256. It feels great to know my thoughts are truly secure.",
    mood: "⚡",
  ...
  },
  {
    ...
    type: "event",
    date: "2026-04-23",
    headline: "First Secure Entry",
    content: "Building my own 'Memory Palace' has been a dream. Today I successfully saved the first encrypted entry to ObjectBox.",
    mood: "🎉",
    feeling: "Social",
  ...
  },
  {
    ...
    content: "Privacy is a right, not a feature. I built DayVault to prove that mobile apps don't need the cloud to be powerful.",
    mood: "😌",
    feeling: "Peaceful",
    timeBucket: "night",
  },
