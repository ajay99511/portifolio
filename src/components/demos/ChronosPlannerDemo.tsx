    ...
    tasks: [
      {
        ...
        completed: false,
        estimatedCost: 0,
        description: "Focus on implementing the Transformer attention head from scratch.",
      },
      {
        id: "c-task-2",
        title: "Morning Run",
        ...
        completed: true,
        estimatedCost: 0,
        description: "Clear my head before the next coding session.",
      },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        completed: false,
        estimatedCost: 0,
        description: "Experimenting with Framer Motion for better project transitions.",
      },
      {
        id: "c-task-4",
        title: "Study Group",
        ...
        completed: false,
        estimatedCost: 0,
        description: "Discussing RAG patterns and vector databases with friends.",
      },
    ],
  },
...
const templateSeed: Template[] = [
  {
    id: "template-1",
    name: "Deep Study Mode",
    description: "My go-to schedule for learning complex new technologies.",
    tasks: [
      {
        ...
        priority: "high",
        estimatedCost: 0,
        description: "Reading papers and official docs to build a mental model.",
      },
      {
        ...
        priority: "high",
        estimatedCost: 0,
        description: "Hands-on implementation of what I just read.",
      },
    ],
  },
  {
    id: "template-2",
    name: "Side-Project Sunday",
    description: "Relaxed pace for working on my personal app ideas.",
    tasks: [
      {
        ...
        priority: "low",
        estimatedCost: 0,
        description: "Cleaning up my code and updating READMEs.",
      },
      {
        title: "Weekly Review",
        start: "17:00",
        ...
        priority: "medium",
        estimatedCost: 0,
        description: "Reflecting on what I learned this week and planning for next.",
      },
    ],
  },
];
